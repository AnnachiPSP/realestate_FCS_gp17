...
from realestate.serializers import UserSerializer, AdminSerializer, PropertySerializer, PropertySearchSerializer, WishlistSerializer
...
def manageProperties(request, selling_type=None, location=None, property_type=None):
    try:
        if request.method == 'GET':
            ...
            print("Failed to validate property data:", property_serializer.errors)
